...
classes = pd.read_csv(r"C:\Users\Sergey\Documents\GitHub\boots-recognition\sergey_solution\data\classes.csv")
...
nn_result.to_csv("./result/tmp_pos_with_nn_another_prioritet_without_ebay.csv", index=0)
print(c)
